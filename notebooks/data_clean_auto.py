...
def clean_data(
    ...
    _generate_report(df, generate_report, output_path)
...
def _handle_missing_values(df: pd.DataFrame) -> pd.DataFrame:
    ...
    Parameters:
        df (pd.DataFrame): The original DataFrame containing missing values.

    Returns:
        pd.DataFrame: The DataFrame after missing values have been filled.
    """
